...
//   ) {
//     const { companyTitle, documentNumber, companyId } = body;
...
//     const newFileName = `${safeCompanyId}_${safeCompanyTitle}-${documentNumber || Date.now()}.${ext}`;
...
//   // 📂 Список документів компанії (має бути вище getDocument!)
...
//       filename,
//       url: `/uploads/documents/${filename}`, // шлях до файлу, бо ми роздаємо через useStaticAssets
//     }));
//   }
// }
//   // 📄 Отримання конкретного документа (цей маршрут останній!)
//   @Get(':filename')
